...
INSERT INTO `Item` VALUES (1,'Ines Lieblingskleid','Kleid','Das mag ich sehr gerne',100,1,'S','blau'),(2,'Simons Hose','Hose','Die mit den Löchern am Knie',10,0,'L','jeans');
...
CREATE TABLE `ItemTagConnection` (
  `ItemTagConnectionId` int(11) NOT NULL AUTO_INCREMENT,
...
-- Dump completed on 2020-06-09 10:54:56
